...
class Helper
{
    public static function generateAvatar($username, $avatarUrl = null): string
    {
        ...
        if ($avatarUrl) {
            ...
            return '<div style="min-height: 2.5rem; min-width: 2.5rem;" class="rounded-full h-10 w-10 min-h-10 min-w-10 flex items-center justify-center text-white text-xl font-bold ' . $randomColor . '">' . $firstCharacter . '</div>';
        }
    }
}
